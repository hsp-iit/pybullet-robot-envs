...
class pandaPushGymEnv(gym.Env):
    ...
    def __init__(self, urdfRoot=robot_data.getDataPath(),
        ...
        self._cam_pitch = -40
        self._h_table = []
        self._target_dist_max = 0.2
        self._target_dist_min = 0.3
        self._p = p
    ...
    def reset(self):
        ...
        self._objID = p.loadURDF( os.path.join(self._urdfRoot,"franka_description/cube_small.urdf"), basePosition = obj_pose)
